    ...
    >
      <div className="relative max-w-[1240px] mx-auto px-6 sm:px-0 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1fr_1fr_1fr_minmax(330px,1.15fr)] pt-[50px] lg:pt-[66px] pb-[44px] lg:pb-[58px] gap-[38px] lg:gap-[clamp(32px,4vw,70px)]">
        <div className="flex flex-col">
          <h3 className="m-[0_0_20px] lg:m-[0_0_28px] pb-[13px] lg:pb-[18px] border-b border-[#d99d39]/80 text-[#d99d39] font-serif text-[23px] lg:text-[25px] font-medium">
            The Grand Store
          </h3>
          <Link
            className="block w-fit m-[0_0_14px] lg:m-[0_0_17px] text-[#f2ede4] font-serif text-[16px] lg:text-[17px] leading-[1.15] transition-all duration-[150ms] hover:text-[#e1bd70] hover:translate-x-[3px]"
            to="/about"
          >
            About us
          </Link>
        ...
        <div className="flex flex-col">
          ...
          <Link
            className="block w-fit m-[0_0_14px] lg:m-[0_0_17px] text-[#f2ede4] font-serif text-[16px] lg:text-[17px] leading-[1.15] transition-all duration-[150ms] hover:text-[#e1bd70] hover:translate-x-[3px]"
            to="/shop?category=Wine&amp;style=Sparkling"
          >
            Sparkling wines
          </Link>
          <Link
            className="block w-fit m-[0_0_14px] lg:m-[0_0_17px] text-[#f2ede4] font-serif text-[16px] lg:text-[17px] leading-[1.15] transition-all duration-[150ms] hover:text-[#e1bd70] hover:translate-x-[3px]"
            to="/shop?category=Wine&amp;style=Red"
          >
            Red wine
          </Link>
          <Link
            className="block w-fit m-[0_0_14px] lg:m-[0_0_17px] text-[#f2ede4] font-serif text-[16px] lg:text-[17px] leading-[1.15] transition-all duration-[150ms] hover:text-[#e1bd70] hover:translate-x-[3px]"
            to="/shop?category=Wine&amp;style=White"
          >
            White wine
          </Link>
          <Link
            className="block w-fit m-[0_0_14px] lg:m-[0_0_17px] text-[#f2ede4] font-serif text-[16px] lg:text-[17px] leading-[1.15] transition-all duration-[150ms] hover:text-[#e1bd70] hover:translate-x-[3px]"
            to="/shop?category=Wine&amp;style=Rose"
          >
            Rosé wine
          </Link>
          <Link
            className="block w-fit m-[0_0_14px] lg:m-[0_0_17px] text-[#f2ede4] font-serif text-[16px] lg:text-[17px] leading-[1.15] transition-all duration-[150ms] hover:text-[#e1bd70] hover:translate-x-[3px]"
            to="/tools/wine-pairing"
          >
            Wine Pairing Tool
          </Link>
          <Link
            className="block w-fit m-[0_0_14px] lg:m-[0_0_17px] text-[#f2ede4] font-serif text-[16px] lg:text-[17px] leading-[1.15] transition-all duration-[150ms] hover:text-[#e1bd70] hover:translate-x-[3px]"
            to="/tools/whisky-finder"
          >
            Whisky Finder
          </Link>
          <Link
        ...
        <div className="col-span-1 md:col-span-2 lg:col-span-1 w-full flex flex-col">
          ...
          <p className="max-w-[430px] m-[0_0_24px] text-[#f2ede4] font-serif text-[18px] lg:text-[20px] leading-[1.48]">
            Subscribe to our newsletter to get latest updates and amazing
            offers.
          </p>
          <form
            className="grid grid-cols-1 sm:grid-cols-[minmax(0,1fr)_auto] border border-[#f2ede4]/70"
          ...
          {newsletterStatus && (
            <p
              className="m-[10px_0_0] text-[#cfc6b7] font-sans text-[11px]"
              role="status"
            >
              {newsletterStatus}
            </p>
          ...
          <div
            className="flex flex-col sm:flex-row items-start sm:items-center mt-[28px] gap-[12px] sm:gap-[18px]"
            aria-label="Download The Grand Store mobile app"
          >
            <a
              className="transition-all duration-[180ms] ease hover:opacity-85 hover:-translate-y-[2px]"
              href="https://apps.apple.com/in/app/grand-store/id6449220111"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                className="w-auto h-[48px] lg:h-[54px] object-contain"
      ...
      <div className="border-t border-[#e1bd70]/20 bg-[#070706]">
        <div className="max-w-[1240px] mx-auto px-6 sm:px-0 grid grid-cols-1 lg:grid-cols-[1fr_minmax(480px,0.9fr)] items-center min-h-[70px] py-[20px] lg:py-0 gap-[18px] lg:gap-[34px] text-[#d6cec0] font-serif text-[16px]">
          <p className="m-0">
            Copyright ©{" "}
            <Link
              className="text-[#f2ede4] no-underline transition-colors hover:text-[#d6a03f]"
              to="/"
            >
              The Grand Store
            </Link>
          ...
          <img
            className="justify-self-start lg:justify-self-end w-auto h-[26px] object-contain object-left lg:object-right"

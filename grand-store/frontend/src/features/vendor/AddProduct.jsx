      ...
      <div className="max-w-4xl w-full">
        ...
        <section className="mb-4">
              <h1 className="text-[var(--color-ivory)] font-serif text-5xl mb-4">
                Add <span className="font-script text-6xl text-[var(--color-gold)] font-normal ml-2 tracking-wide drop-shadow-[0_0_15px_rgba(212,175,55,0.3)]">Retail Product</span>
              </h1>

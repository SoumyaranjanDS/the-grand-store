...
const BOTTLE_CATEGORIES = [
  ...
  {
    id: 'wine',
    name: 'Ch├óteau Margaux Grand Vin',
    category: 'Wine',
  ...
  {
    id: 'champagne',
    name: 'Veuve De Saint-Hilaire Grand Cuv├⌐e',
    category: 'Champagne',
  ...
  {
    id: 'cognac',
    name: 'Cognac R├⌐serve H├⌐ritage X.O.',
    category: 'Cognac',
    vintage: '25 Year X.O. H├⌐ritage',
  ...
  },
  {
    ...
    category: 'Tequila',
    vintage: 'Highland Reposado & A├▒ejo',
  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          maskImage: 'linear-gradient(to left, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.80) 35%, rgba(0,0,0,0.50) 55%, rgba(0,0,0,0.16) 72%, rgba(0,0,0,0.02) 82%, rgba(0,0,0,1) 92%)',
          WebkitMaskImage: 'linear-gradient(to left, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.80) 35%, rgba(0,0,0,0.50) 55%, rgba(0,0,0,0.16) 72%, rgba(0,0,0,0.02) 82%, rgba(0,0,0,1) 92%)',
        }}
      >
        <img 
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(ellipse 65% 55% at 0% 28%, rgba(229, 169, 60, 0.12) 0%, rgba(192, 132, 26, 0.03) 45%, transparent 75%)',
        }}
      />
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(ellipse 95% 85% at 100% 45%, rgba(245, 185, 55, 0.18) 0%, rgba(229, 169, 60, 0.10) 35%, rgba(192, 132, 26, 0.03) 65%, transparent 90%)',
        }}
      />
      <div 
        className="absolute inset-y-0 right-0 w-1/3 sm:w-1/4 pointer-events-none z-[1] max-sm:opacity-40 sm:opacity-100" 
        style={{
          background: 'linear-gradient(to left, rgba(245, 185, 55, 0.10) 0%, rgba(229, 169, 60, 0.04) 50%, transparent 100%)',
        }}
      />
      ...
      <div className="absolute inset-y-0 right-0 w-full sm:w-9/12 md:w-8/12 pointer-events-none z-[2] overflow-hidden select-none max-sm:opacity-30 sm:opacity-68">
        ...
        <div className="absolute top-[18%] right-[18%] text-[#ffeaa7] text-lg sm:text-xl animate-luxury-glitter opacity-80">Γ£ª</div>
        <div className="absolute top-[42%] right-[10%] text-[#ffd700] text-sm sm:text-base animate-luxury-glitter-delay-1 opacity-80">Γ£º</div>
        <div className="absolute top-[68%] right-[26%] text-[#ffda79] text-base sm:text-lg animate-luxury-glitter-delay-2 opacity-80">Γ£ª</div>
        <div className="absolute top-[28%] right-[6%] text-[#fff3b0] text-xs sm:text-sm animate-luxury-glitter-delay-3 opacity-80">Γ£º</div>
        <div className="absolute top-[82%] right-[14%] text-[#ffd700] text-sm sm:text-base animate-luxury-glitter opacity-80">Γ£ª</div>
      </div>
        ...
        <div className="relative w-full flex-1 flex items-center justify-center my-auto py-1">
          ...
          <div className="absolute max-sm:top-2 max-sm:left-2 sm:inset-y-0 sm:left-0 flex max-sm:items-start sm:items-center justify-start pl-0 sm:-translate-y-18 md:-translate-y-24 lg:-translate-y-28 pointer-events-none select-none z-10">
            <div className="flex flex-col items-start select-none text-left not-italic">
              ...
              <h1 
                className="font-serif not-italic text-[26px] sm:text-[clamp(28px,4.4vw,64px)] font-bold uppercase text-left leading-[0.85] sm:leading-[0.96] whitespace-nowrap select-none m-0 p-0 flex flex-col"
                style={{ 
              ...
              >
                ...
                <span 
                  className="tracking-[0.05em] sm:tracking-[0.18em]"
                  style={{ 
                    backgroundImage: 'linear-gradient(135deg, #fff8e7 0%, #ffe299 18%, #e5a93c 45%, #ffd269 72%, #a86c0c 100%)',
                    WebkitBackgroundClip: 'text',
                    WebkitTextFillColor: 'transparent',
                    filter: 'drop-shadow(0 2px 14px rgba(229, 169, 60, 0.40)) drop-shadow(0 6px 24px rgba(0,0,0,0.95))',
                  }}
                >
                  The
                </span>
                ...
                <span 
                  className="tracking-[0.02em] sm:tracking-[0.10em]"
                  style={{
                    backgroundImage: 'linear-gradient(135deg, #fff8e7 0%, #ffe299 18%, #e5a93c 45%, #ffd269 72%, #a86c0c 100%)',
                    WebkitBackgroundClip: 'text',
                    WebkitTextFillColor: 'transparent',
          ...
          <div className="relative z-20 shrink-0 flex items-center justify-center pointer-events-auto cursor-pointer group animate-beer-float max-sm:translate-y-1 sm:-translate-y-1 md:-translate-y-4 max-sm:min-h-[355px] sm:min-h-[380px] md:min-h-[450px] lg:min-h-[520px] max-sm:w-[270px] sm:w-[280px] md:w-[400px]">
            ...
            <div 
              ...
              style={{
                background: 'radial-gradient(ellipse 65% 75% at 50% 50%, rgba(255, 230, 130, 0.55) 0%, rgba(245, 185, 55, 0.32) 42%, rgba(229, 169, 60, 0.10) 65%, transparent 82%)',
              }}
            />
            ...
            <div className="absolute -inset-10 pointer-events-none -z-10 overflow-visible select-none">
              ...
              <div className="absolute top-[8%] left-[12%] text-[#ffeaa7] text-lg sm:text-xl drop-shadow-[0_0_8px_#ffd700] animate-luxury-glitter">Γ£ª</div>
              
              {/* Top Right Sparkle Star */}
              <div className="absolute top-[14%] right-[10%] text-[#ffd700] text-sm sm:text-base drop-shadow-[0_0_8px_#ffd700] animate-luxury-glitter-delay-1">Γ£º</div>
              
              {/* Mid Left Sparkle Star */}
              <div className="absolute top-[48%] left-[4%] text-[#ffda79] text-base sm:text-lg drop-shadow-[0_0_6px_#ffd700] animate-luxury-glitter-delay-2">Γ£ª</div>
              
              {/* Mid Right Sparkle Star */}
              <div className="absolute top-[42%] right-[6%] text-[#fff3b0] text-xs sm:text-sm drop-shadow-[0_0_6px_#fff3b0] animate-luxury-glitter-delay-3">Γ£º</div>
              
              {/* Bottom Left Sparkle Star */}
              <div className="absolute bottom-[16%] left-[10%] text-[#ffd700] text-sm sm:text-base drop-shadow-[0_0_8px_#ffd700] animate-luxury-glitter">Γ£ª</div>
              
              {/* Bottom Right Sparkle Star */}
              <div className="absolute bottom-[22%] right-[12%] text-[#ffeaa7] text-base sm:text-lg drop-shadow-[0_0_8px_#ffd700] animate-luxury-glitter-delay-1">Γ£º</div>
          ...
          <div className="absolute max-sm:right-3 max-sm:bottom-3 sm:right-16 md:right-24 lg:right-32 sm:bottom-20 md:bottom-28 lg:bottom-36 z-30 pointer-events-auto">
            ...
            >
              ...
              <div 
                ...
                style={{
                  background: 'radial-gradient(ellipse 80% 80% at 75% 50%, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.60) 50%, transparent 85%)',
                }}
              />
              ...
              <h2 
                ...
                style={{ 
                  ...
                  backgroundImage: 'linear-gradient(135deg, #ffffff 0%, #ffffff 38%, #fff4c7 65%, #ffd700 90%, #e5a93c 100%)',
                  WebkitBackgroundClip: 'text',
                  WebkitTextFillColor: 'transparent',
                  filter: 'drop-shadow(0 2px 8px rgba(0,0,0,1)) drop-shadow(0 6px 28px rgba(0,0,0,0.98)) drop-shadow(0 0 24px rgba(255,215,0,0.40))',
                }}
              >

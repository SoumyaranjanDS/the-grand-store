  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-y-0 right-0 w-full sm:w-9/12 md:w-8/12 pointer-events-none z-[2] overflow-hidden select-none max-sm:opacity-30 sm:opacity-68">
        ...
        <div className="absolute top-[18%] right-[18%] text-[#ffeaa7] text-lg sm:text-xl animate-luxury-glitter opacity-80">✦</div>
        <div className="absolute top-[42%] right-[10%] text-[#ffd700] text-sm sm:text-base animate-luxury-glitter-delay-1 opacity-80">✧</div>
        <div className="absolute top-[68%] right-[26%] text-[#ffda79] text-base sm:text-lg animate-luxury-glitter-delay-2 opacity-80">✦</div>
        <div className="absolute top-[28%] right-[6%] text-[#fff3b0] text-xs sm:text-sm animate-luxury-glitter-delay-3 opacity-80">✧</div>
        <div className="absolute top-[82%] right-[14%] text-[#ffd700] text-sm sm:text-base animate-luxury-glitter opacity-80">✦</div>
      </div>
        ...
        <div className="relative w-full flex-1 flex items-center justify-center my-auto py-1">
          ...
          <div className="relative z-20 shrink-0 flex items-center justify-center pointer-events-auto cursor-pointer group animate-beer-float max-sm:translate-y-1 sm:-translate-y-1 md:-translate-y-4 max-sm:min-h-[355px] sm:min-h-[380px] md:min-h-[450px] lg:min-h-[520px] max-sm:w-[270px] sm:w-[280px] md:w-[400px]">
            ...
            <div className="absolute -inset-10 pointer-events-none -z-10 overflow-visible select-none">
              ...
              <div className="absolute top-[8%] left-[12%] text-[#ffeaa7] text-lg sm:text-xl drop-shadow-[0_0_8px_#ffd700] animate-luxury-glitter">✦</div>
              
              {/* Top Right Sparkle Star */}
              <div className="absolute top-[14%] right-[10%] text-[#ffd700] text-sm sm:text-base drop-shadow-[0_0_8px_#ffd700] animate-luxury-glitter-delay-1">✧</div>
              
              {/* Mid Left Sparkle Star */}
              <div className="absolute top-[48%] left-[4%] text-[#ffda79] text-base sm:text-lg drop-shadow-[0_0_6px_#ffd700] animate-luxury-glitter-delay-2">✦</div>
              
              {/* Mid Right Sparkle Star */}
              <div className="absolute top-[42%] right-[6%] text-[#fff3b0] text-xs sm:text-sm drop-shadow-[0_0_6px_#fff3b0] animate-luxury-glitter-delay-3">✧</div>
              
              {/* Bottom Left Sparkle Star */}
              <div className="absolute bottom-[16%] left-[10%] text-[#ffd700] text-sm sm:text-base drop-shadow-[0_0_8px_#ffd700] animate-luxury-glitter">✦</div>
              
              {/* Bottom Right Sparkle Star */}
              <div className="absolute bottom-[22%] right-[12%] text-[#ffeaa7] text-base sm:text-lg drop-shadow-[0_0_8px_#ffd700] animate-luxury-glitter-delay-1">✧</div>

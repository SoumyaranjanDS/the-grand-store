...
export default function WhiskyShowcase({ onAdd, onWish, onCompare, compareItems }) {
  ...
  return (
    <>
      <section className="section tequila-showcase home-product-editorial" id="whisky" ref={sectionRef}>
        <div className="shell">
          <div className="section-heading flex flex-col items-start text-left md:flex-row md:text-left md:justify-between md:items-end gap-3 md:gap-0">
            ...
            <Link className="text-link arrow-link flex items-center gap-1" to="/shop?category=Whisky">
              <span className="hidden md:inline">View all whisky</span>
      ...
      <section className="home-brand-marquee relative py-8 md:py-10 border-t border-white/10 bg-[#0b0a08] overflow-hidden" aria-labelledby="whisky-brands-title">
        <div className="relative max-w-[1440px] mx-auto text-center sm:px-8 lg:px-7">
          <div className="home-brand-marquee-panel relative border-y sm:border border-white/10 sm:rounded-2xl py-8 bg-white/[0.01]">
            <div className="home-brand-marquee-heading mb-8 relative px-6 sm:px-0">
              <h2 id="whisky-brands-title" className="home-brand-marquee-title m-0 font-serif text-[clamp(24px,2.5vw,36px)] font-medium tracking-[-0.02em] leading-[1.05] text-[#eee8dd] relative z-10">
                Top Whisky Brands
              </h2>

        ...
        <div className="site-footer__links-col site-footer__address-col">
          ...
          <div className="footer-contact">
            <p>
              <MapPin size={16} />{" "}
              <span>
                Cigar Connoisseur Club, C/O-Nivarp International (Pty) ltd. PO
                Box
                <br />
                1022, Saxonwold. 2196 Rosebank mall, Johannesburg. South Africa.
              </span>
            </p>
            <p>
              <Mail size={16} /> <span>info@cigarconnoisseurclub.com</span>
            </p>
            <p>
              <Phone size={16} /> <span>+27 82 496 7256</span>
            </p>
          </div>
        </div>

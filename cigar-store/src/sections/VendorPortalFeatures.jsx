...
const portalFeatures = [
  {
    icon: 'https://grandstore.co.za/public/front/assets/img/media/9.png',
    title: 'Dashboard',
    description: 'Brings together all the data you need to plan and fulfill your upcoming orders'
  },
  {
    icon: 'https://grandstore.co.za/public/front/assets/img/media/10.png',
    title: 'Account',
    description: 'Manage your payments.'
  },
  {
    icon: 'https://grandstore.co.za/public/front/assets/img/media/11.png',
    title: 'Stock',
    description: 'Different product Categories'
  },
  {
    icon: 'https://grandstore.co.za/public/front/assets/img/media/12.png',
    title: 'Data',
    description: 'Make sure you stay informed about your customer ordering patterns etc.'
  },
  {
    icon: 'https://grandstore.co.za/public/front/assets/img/media/13.png',
    title: 'Sales',
    description: 'Manage your sales.'
  },
  {
    icon: 'https://grandstore.co.za/public/front/assets/img/media/14.png',
    title: 'Orders',

...
function Navbar() {
  ...
  useEffect(() => {
    const updateHeader = () => {
      ...
      // Hide if scrolling down and past 100px, show if scrolling up or at top
      ...
      setScrolled(currentScrollY > (threshold > 50 ? threshold - 88 : 30));
    };
    updateHeader();
  ...
  return (
    ...
    >
      <div className="navbar-main">
        <div className="navbar-main__inner">
          <a
            className="brand"
            href="/#top"
            aria-label="Cigar Connoisseur Club home"
          >
            <img
              className="brand-logo"
              src={brandLogo}
              alt="Cigar Connoisseur Club"
            />
          </a>
          ...
          <div className="nav-actions">
            <button
              ...
              aria-label={`Wishlist, ${savedCount} saved ${savedCount === 1 ? "cigar" : "cigars"}`}
            >
              <Heart
                size={21}
                strokeWidth={1.4}
      ...
      <form
        className={`navbar-search-panel ${searchOpen ? "navbar-search-panel--open" : ""}`}
